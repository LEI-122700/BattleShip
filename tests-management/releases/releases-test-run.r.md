...
* [unknown] C5 CompassTest - teste char direções, tostring, válidos e devolve UNKOWN
...
* [unknown] C7 FrigateTest - test tamanho 4 e preenchimento das 4 posições nas direções NORTH, SOUTH, EAST e WEST

* [unknown] C8 GalleonTest - testa tamanho 5, exceção no construtor com bearing null e forma em T nas direções NORTH, SOUTH, EAST e WEST

* [unknown] C9 GamesTest - testa o construtor e contadores, validShot/repeatedShot, getRemainingShips, os 5 ramos de fire(pos)  e os métodos print (printValidShots, printFleet)

* [unknown] C10 PositionTest - testa construtor, equals/hashCode, isAdjacentTo, ocupar/disparar e toString
